...
from services.set_collector import handle_process_universal_field_input
from keyboards.start_kb import start_kb
from keyboards.training_kb import (CategoryCallback, ExerciseCallback, training_kb, set_kb,
                                            continue_set_adding_kb, create_categories_kb, create_exercises_kb,
                                            date_choice_kb, duration_choice_kb, types_kb)

from services.exercise_type_config import EXERCISE_TYPE_CONFIG, FIELD_PROMPTS
